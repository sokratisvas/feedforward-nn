...
Matrix* get_second_layer_output_matrix(NeuralNet* neuralnet, Matrix* input, Matrix* first_layer_output);
double means_squared_error(Matrix* calculated_output, Matrix* output);
...
// void backward(Matrix* calculated_output, Matrix* actual_output);
